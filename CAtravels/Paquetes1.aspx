   ...
   <div class="col-md-12">
    ...
    <div class="card horizontal">
      <div class="card-image2" id="img" align="center">
        <img src="imagenes/guate-CATravels.png" style=" height: 300px; width: 400px;">
      </div>
    ...
    <div class="card horizontal">
      <div class="card-image2" id="img" align="center">
        <img src="imagenes/7-rotado.jpg" style=" height: 300px; width: 400px;">
      </div>
      <div class="card-stacked">
        <div class="card-content">
    ...
    <div class="card horizontal">
      <div class="card-image2" id="img" align="center">
        <img src="imagenes/Que-hacer-en-Ciudad-de-Panamá-Conocer-lugares-y-destinos-turísticos-1-1.png"style=" height: 300px; width: 400px;">
      </div>
      <div class="card-stacked">
        <div class="card-content">
        ...
        <div class="card-action" id="img4">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <asp:LinkButton ID="LBMpanama" runat="server" OnClick="LBMpanama_Click">More Information</asp:LinkButton>
        </div>
      </div>
    </div>		
    ...
    <div class="card horizontal">
      <div class="card-image2" id="img" align="center">
        <img src="imagenes/yojoa-lake-honduras.jpg"style=" height: 300px; width: 400px;">
      </div>
      <div class="card-stacked">
        <div class="card-content">
    ...
    <div class="card horizontal">
      <div class="card-image2" id="img" align="center">
        <img src="imagenes/vuelos-san-jose_b1-san-jose_es.jpg" style=" height: 300px; width: 400px;">
      </div>
      <div class="card-stacked">
        <div class="card-content">
